    ...
    <div>
      <div class="container d-none d-md-block">
        <div className="row justify-content-center mt-1 mt-md-5">
          <div className="col-6 col-md-6  secondfoot">
          ...
          <div className="col-6 col-md-2   secondfoot">
          ...
          <div
            className="col-6 col-md-2  secondfoot"
          ...
          <div className="col-12 mt-5 py-2 text-white">
      ...
      <div className="container d-block d-md-none">
        <div className="row ">
          <div className="col-12 contactdropss">
